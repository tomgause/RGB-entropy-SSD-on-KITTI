...
def vgg(i):
    ...
    layers = [
        ...
        entropy_func(),nn.Conv2d(64,64,kernel_size=3,padding=1),nn.Sigmoid(),
        entropy_layer(),
        # Conv2_1, Conv2_2, Pool2
        nn.Conv2d(64, 128, kernel_size=3, padding=1), nn.BatchNorm2d(128), nn.ReLU(),
        nn.Conv2d(128, 128, kernel_size=3, padding=1), nn.BatchNorm2d(128), nn.ReLU(),
        nn.MaxPool2d(kernel_size=2), nn.BatchNorm2d(128), nn.ReLU(),
        entropy_func(), nn.Conv2d(128, 128, kernel_size=3,padding=1),nn.Sigmoid(),
        entropy_layer(),
        ...
        entropy_func(), nn.Conv2d(256,256, kernel_size=3,padding=1),nn.Sigmoid(),
        entropy_layer(),
        ...
        entropy_func(), nn.Conv2d(512,512, kernel_size=3,padding=1),nn.Sigmoid(),
        entropy_layer(),
...
def add_extras():
    layers = [
        ...
        entropy_func(), nn.Conv2d(1024, 1024, kernel_size=3,padding=1),nn.Sigmoid(),
        entropy_layer(),
        # Conv7, THIRD SOURCE
...
def multibox(vgg, extra_layers, cfg, num_classes):
    ...
    for k, v in enumerate(extra_layers[7::10], 2):#[3::6]
